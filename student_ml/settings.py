...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-f%oo937d!%@hi80qq6_0w)70wj50en5%_m2t$o#0n@ss+6ki0w')
...
# Use DATABASE_URL if available (for Render, Heroku, etc.)
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'PASSWORD': config('DB_PASSWORD', default='1994'),
